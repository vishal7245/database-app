...
export default async function HealthyPage({ searchParams }: PageProps) {
  ...
  try {
    ...
    return (
      <div>
        <h1 className="text-2xl text-black font-bold mb-6">Healthy Data</h1>
    ...
    return (
      <div className="text-center py-8">
        ...
        <p className="text-gray-600">Failed to load Healthy data. Please try again later.</p>
      </div>
    );
  }
}
