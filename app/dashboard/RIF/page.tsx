...
export default async function RIFPage({ searchParams }: PageProps) {
  ...
  // Parse the current page number or default to 1
  ...
  try {
    ...
    return (
      <div>
        <h1 className="text-2xl text-black font-bold mb-6">RIF Data</h1>
        {data.length > 0 ? (
    ...
    return (
      <div className="text-center py-8">
        ...
        <p className="text-gray-600">Failed to load RIF data. Please try again later.</p>
      </div>
    );
  }
}
